# UPD от 06.07.2020
* Завод превратился в концерн, теперь можно запустить сразу фабрики и на категории и на
 товары при помощи **php artisan db:seed**
* В корне админки /admin теперь можно установить адрес для уведомлений
